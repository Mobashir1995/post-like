...
function lp_show_frontend( $attr, $content='' ){
	...
	$output  = "";
	$output .= "<div class='lp_like_count like-count-wrapper'><div class='text-wrapper'><p>".$total_like."</p></div></div>";
	$output .= "<div class='like-button-wrapper'><a href='javascript:void(0)' class='lp_like_btn' data-total-like='".$total_like."' data-post-id='".$id."'><div class='like-button'><p>LIKE!</p></div></a></div>";
